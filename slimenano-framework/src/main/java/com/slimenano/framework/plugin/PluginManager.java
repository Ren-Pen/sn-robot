...
import com.slimenano.framework.config.PluginConfiguration;
...
public class PluginManager {
    ...
    public boolean load(String jarFileName){
        ...
        if (pluginConfiguration.isSimplyJarFile()) {
        ...
        try {
            ...
            if (!pluginConfiguration.getTrust().containsKey(sha1)) {
            ...
            PluginMeta meta = new PluginMeta(jarFile, context, bean, classLoader, information, sha1);
            ...
            pluginConfiguration.getTrust().put(sha1, new PluginConfiguration.PL(jarFileName, information.getPath(), sha1));
